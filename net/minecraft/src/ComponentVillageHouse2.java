...
public class ComponentVillageHouse2 extends ComponentVillage
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        placeBlockAtCurrentPosition(world, Block.stairCompactPlanks.blockID, func_35301_c(Block.stairCompactPlanks.blockID, 3), 2, 1, 5, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.stairCompactPlanks.blockID, func_35301_c(Block.stairCompactPlanks.blockID, 1), 1, 1, 4, structureboundingbox);
        for(int i = 6; i <= 8; i++)
        {
            if(func_35297_a(world, i, 0, -1, structureboundingbox) == 0 && func_35297_a(world, i, -1, -1, structureboundingbox) != 0)
            {
                placeBlockAtCurrentPosition(world, Block.stairCompactCobblestone.blockID, func_35301_c(Block.stairCompactCobblestone.blockID, 3), i, 0, -1, structureboundingbox);
            }
        }
