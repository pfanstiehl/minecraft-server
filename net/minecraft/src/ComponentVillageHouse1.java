...
public class ComponentVillageHouse1 extends ComponentVillage
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        {
            averageGroundLevel = getFoundationLevel(world, structureboundingbox);
            if(averageGroundLevel < 0)
            {
                return true;
            }
            boundingBox.offset(0, ((averageGroundLevel - boundingBox.y2) + 9) - 1, 0);
        }
        ...
        placeBlockAtCurrentPosition(world, Block.stairCompactPlanks.blockID, func_35301_c(Block.stairCompactPlanks.blockID, 0), 7, 1, 3, structureboundingbox);
